...
public class UserController implements CommunityConstant {
    ...
    @RequestMapping(path = "/modifiy", method = RequestMethod.POST)
    public String modifiyPassword(String oldPassword, String newPassword, String confirmPassword, Model model) {
        //获取登录用户
        User user = hostHolder.getUser();
        if (newPassword == null) {
            model.addAttribute("newPasswordMsg", "新密码输入为空！!");
            return "/site/setting";
        }
